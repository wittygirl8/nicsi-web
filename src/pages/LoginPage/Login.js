            ...
            <div className="container-fluid">
                ...
                <div className="col-sm-6 text-black">
                    ...
                    <form style={{width: '23rem'}}>
                        <h3 className="fw-normal mb-3 pb-3" style={{letterSpacing: 1, color:'white'}}> Candidate Sign In</h3>
                        ...
                        <div className="form-outline mb-4"><div class="input-group mb-3">
                        ...
                        <p className="small mb-5 pb-lg-2 text-center"><Link to='/admin-sign-in' className="signup-image-link link-info"> Admin Sign In </Link><Link to='/coordinator-sign-in' className="signup-image-link link-info ml-2 "> Co-ordinator Sign In </Link></p>
